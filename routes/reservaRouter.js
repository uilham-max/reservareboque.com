...
router.get('/admin/historico', autorizacao,)
router.post('/admin/filtrarHistorico', autorizacao,)
router.get('/admin/lucro', autorizacao,)
router.post('/admin/filtrar', autorizacao,)
